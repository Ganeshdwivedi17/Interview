...
const DemoScreen = ({ setMainScreen, mainScreen = '', setJobViewContext }: { setMainScreen: any, mainScreen?: any,setJobViewContext:any }) => {
      ...
      <div className="pageContainer" style={{ padding: 0, gap: 0 }}>
        ...
        <div className="leftSideDiv rightSideBg pos-rel over-hdn auth-page bg-transparent" style={{ borderRadius: 0 }}>
          <div className="leftSideHeader kjsf-ajmwe w-100">
            <BackButton setJobViewContext={setJobViewContext} setMainScreen={setMainScreen} />
          </div>
          ...
          <Carousel nextInterview={nextInterview} setPaginate={setPaginate} selectedInterview={selectedInterview} setMainScreen={setMainScreen} paginate={paginate} />
        ...
        <RightLayout setJobViewContext={setJobViewContext} mainScreen={mainScreen} setMainScreen={setMainScreen} setShowScreen={''} />
