...
function renderScreen(screen: number,fromPreview:any, setScreen: any, jobViewContext: any, recorded: any, setRecorded: any, setMainScreen: any, fromShareScreen: any, setJobViewContext: any, setFromShareScreen: any) {
  return (
    <>
...
function Next({ jobViewContext,fromPreview, setMainScreen, fromShareScreen, setJobViewContext, setFromShareScreen }: { jobViewContext: any, setMainScreen: any, fromShareScreen: any, setJobViewContext: any, setFromShareScreen: any,fromPreview?:any }) {
