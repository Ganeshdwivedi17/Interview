...
useEffect(() => {
  ...
  const updateJob = (params:any)=>{
     axios
      .patch(`${process.env.REACT_APP_BACKEND_URL}/interviewer/${id}`, params)
      .then(async response => {
        setJobView(response.data)
        setShowScreen(6);
      })
  ...
  return (
    <div className="d-flex justify-content-center">
      <div className="kjjfds-janwkea1 kjjfds-janwkea2 kjasdkamsl-wjmd white-form height-none hover-anim">
        <div className="check-form">
          ...
          <div className="check-form-btn-div snasdj-sawdne-1">
            <button
              ...
              onClick={() => {
               id?updateJob(newJob):addJob(newJob)
